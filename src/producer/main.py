...
# Set your unique company limit
MAX_UNIQUE_COMPANIES = 5000
company_set = set()
while len(company_set) < MAX_UNIQUE_COMPANIES:
    company_set.add(fake.company())

# Convert set to list for use with random.choice()
unique_companies: List[str] = list(company_set)
...
class TransactionProducer:
    ...
    def generate_transaction(self) -> Optional[Dict[str, Any]]:
        ...
        transaction = {
            ...
            "currency": "USD",
            "merchant": random.choice(unique_companies),
